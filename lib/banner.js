  ...
  for (var i=0; i<S.length; i++) {
    ...
    for (var j=0; j<bigLetters.length; j++) {
      if (letterIdx < 0 || letterIdx >= letterCount) {
        ...
        console.error('no char for code', code, char, letterIdx);
      } else {
...
function printBanner(s, printfxn) {
  var barr = banner(s),
    log = printfxn?printfxn:console.log;
...
// print input from CLI if passed in, else print from stdin
